...
export const icons = {
    ...
    circle_clock: TIME_ICON,
    play: PLAY_ICON,
    clock: CLOCK_ICON,
    thumbup: THUMBUP_ICON,
    fire: FIRE_ICON,
    music: MUSIC_ICON,
    heartgame: HEART_GAME_ICON,
    newspaper: NEWSPAPER_ICON,
    cup: CUP_ICON,
    createyt: CREATEYT_ICON,
    playyt: PLAYYT_ICON,
    playyt2: PLAYYT2_ICON,
    palyyt3: PLAYYT3_ICON,
