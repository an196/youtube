...
export class SearchbarComponent {
  constructor(iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
    ...
    iconRegistry.addSvgIconLiteral('search2', sanitizer.bypassSecurityTrustHtml(SEARCH_ICON2));
    iconRegistry.addSvgIconLiteral('micro', sanitizer.bypassSecurityTrustHtml(MICRO_ICON));
  }
}
